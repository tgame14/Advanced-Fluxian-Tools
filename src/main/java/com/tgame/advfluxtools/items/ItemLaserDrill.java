...
public class ItemLaserDrill extends Item implements IEnergyContainerItem
{
	...
	public int receiveEnergy(ItemStack container, int maxReceive, boolean simulate)
	{
		...
		int energyReceived = MathUtility.minInt(capacity - energy, MathUtility.minInt(this.maxRec, maxReceive));
		if (!simulate)
		{
	...
	public int extractEnergy(ItemStack container, int maxExtract, boolean simulate)
	{
		...
		int energy = tags.getInteger("Energy");
		int energyExtracted = MathUtility.minInt(energy, MathUtility.minInt(this.maxExt, maxExtract));
		if (!simulate)
		{
